...
bool loadMedia() {
    ...
    KeyPressSurfacesArray[KEY_PRESS_SURFACE_DEFAULT] = loadSurface("key_press/default.png");
    ...
    // load up surface
    KeyPressSurfacesArray[KEY_PRESS_SURFACE_UP] = loadSurface("key_press/up.png");
    ...
    // load down surface
    KeyPressSurfacesArray[KEY_PRESS_SURFACE_DOWN] = loadSurface("key_press/down.png");
    ...
    // load left surface
    KeyPressSurfacesArray[KEY_PRESS_SURFACE_LEFT] = loadSurface("key_press/left.png");
    ...
    // load right surface
    KeyPressSurfacesArray[KEY_PRESS_SURFACE_RIGHT] = loadSurface("key_press/right.png");
