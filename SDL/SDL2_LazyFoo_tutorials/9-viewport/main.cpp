...
int main() {
    if(!init()) {
        ...
        if(!loadMedia()) {
            ...
            // top left viewport
            // set the dimensions of the viewport in an SDL_Rect
            ...
            while(!quit) {
                ...
                // set the viewport, all the following calls after this function will render to the 
                // viewport set 
                ...
                SDL_RenderCopy(renderer,currentTexture,&topLeftViewport,NULL);
